//
//  ClocketSyncAudioUnit.m
//  ClocketSync
//
//  Created by Wes Delp on 10/1/20.
//

#import "ClocketSyncAudioUnit.h"
...
@interface ClocketSyncAudioUnit ()
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[ClocketSyncDSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block ClocketSyncDSPKernelAdapter * kernelAdapter = _kernelAdapter;
